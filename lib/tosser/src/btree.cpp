...
template <class T> BTree<T>::BTree(const char* newid, const T& newdata)
{
...
template <class T> BTree<T>::BTree(const BTree<T>& copy) { Copy(copy); }

template <class T> void BTree<T>::Copy(const BTree<T>& copy)
{
	if (copy.ltree) {
...
template <class T> BTree<T>::~BTree() { Empty(); }
...
template <class T> void BTree<T>::PutData(const char* newid, const T& newdata)
{
...
template <class T> void BTree<T>::RemoveData(const char* newid)
{
...
template <class T> void BTree<T>::RemoveData(const char* newid, const T& newdata)
{
...
template <class T> T BTree<T>::GetData(const char* searchid)
{
...
template <class T> void BTree<T>::AppendRight(BTree<T>* tempright)
{
...
template <class T> BTree<T>* BTree<T>::LookupTree(const char* searchid)
{
...
template <class T> int BTree<T>::Size() const
{
...
template <class T> BTree<T>* BTree<T>::Left() const { return (BTree<T>*)ltree; }

template <class T> BTree<T>* BTree<T>::Right() const { return (BTree<T>*)rtree; }
...
template <class T> void BTree<T>::RecursiveConvertToDArray(DArray<T>* darray, BTree<T>* btree)
{
...
template <class T> void BTree<T>::RecursiveConvertIndexToDArray(DArray<char*>* darray, BTree<T>* btree)
{
