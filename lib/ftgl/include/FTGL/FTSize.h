...
public:
	 ...
	 * @return          <code>true</code> if the size has been set. Clients should check Error() for more
	 * information if this function returns false()
	 */
	bool
	CharSize(FT_Face* face, unsigned int point_size, unsigned int x_resolution, unsigned int y_resolution);
