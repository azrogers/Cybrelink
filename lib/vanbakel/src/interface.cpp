...
void Svb_button_draw(Button* button, bool highlighted, bool clicked)
{
	...
	if (clicked) {
		...
		glColor4f(0.2f, 0.2f, 0.9f, 0.6f);
	} else {
		glColor4f(0.0f, 0.0f, 0.4f, 0.6f);
	}
...
static void Svb_button_highlight(Button* button)
{
...
static void Svb_button_click(Button* button)
{
...
static void Svb_decrease_click(Button* button)
{
...
static void Svb_column_click(Button* button)
{
...
static void Svb_increase_click(Button* button)
{
...
void SvbCreateColumn(int baseX, int baseY, TaskWrapper* tw, int taskindex)
{
	...
	if (tw) {
		...
		EclRegisterButtonCallbacks(
			name, Svb_column_draw, Svb_column_click, Svb_button_click, Svb_button_highlight);
		...
		EclRegisterButtonCallbacks(
			name_decrease, Svb_button_draw, Svb_decrease_click, Svb_button_click, Svb_button_highlight);
		EclRegisterButtonCallbacks(
			name_increase, Svb_button_draw, Svb_increase_click, Svb_button_click, Svb_button_highlight);
	}
}
