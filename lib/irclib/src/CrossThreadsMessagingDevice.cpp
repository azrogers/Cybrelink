...
public:
	InitialiseMutex() { InitializeCriticalSection(&CCrossThreadsMessagingDevice::queue_mutex); }
};
...
void CCrossThreadsMessagingDevice::Post(WPARAM wParam, LPARAM lParam) { enqueue(Msg(this, wParam, lParam)); }
