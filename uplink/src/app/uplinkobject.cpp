...
bool UplinkObject::Load(FILE* file) { return true; }
...
std::string UplinkObject::GetID() { return "UOBJ"; }
...
char* UplinkObject::GetID_END()
{
	...
	UplinkSnprintf(id_end, id_endsize, "%s_END", GetID().c_str());
	return id_end;
}

int UplinkObject::GetOBJECTID() { return OID_UNKNOWN; }
