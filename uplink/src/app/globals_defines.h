...
// #define     FULLGAME                                           // The finished, complete game for CD
// distribution #define     DEMOGAME                                           // Limit rating, stop story
// progression #define     TESTGAME                                           // An internal build, with
// disabled start sequence

#if !defined(FULLGAME) && !defined(DEMOGAME) && !defined(TESTGAME)
	#error "One of FULLGAME DEMOGAME or TESTGAME must be defined"
#endif

/*#define     VERSION_NUMBER_INT      "10.0"                       // Only the 2 first digit after the . are
effective #define     VERSION_NAME_INT        "RELEASE"*/
...
// SAVEFILE_VERSION 59 change fread of char [] for LoadDynamicString/SaveDynamicString in
// world\computer\computerscreen\passwordscreen.cpp,
//                     game\gameobituary.cpp, interface\remoteinterface\remoteinterface.cpp,
//                     world\computer\bankaccount.cpp, world\computer\gateway.cpp,
//                     world\generator\plotgenerator.cpp, world\scheduler\arrestevent.cpp,
//                     world\scheduler\attemptmissionevent.cpp, world\scheduler\bankrobberyevent.cpp,
//                     world\scheduler\seizegatewayevent.cpp, world\scheduler\shotbyfedsevent.cpp,
...
// #define	CHEATMODES_ENABLED									// Eg all-links, all-software, password-bypass
// etc
#if defined(FULLGAME)
// Remove code card check for all builds
// #define     CODECARD_ENABLED                                    // Do the code card lookup thingy at the
// start
#endif
...
#if !defined(DEMOGAME)
// #define     GAME_WINNING_CODE                                 // Show the winning code on the obituary
// interface and send a ingame message
