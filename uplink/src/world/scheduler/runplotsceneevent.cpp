...
char* RunPlotSceneEvent::GetShortString() { return GetLongString(); }
...
std::string RunPlotSceneEvent::GetID() { return "EVT_PLOT"; }

int RunPlotSceneEvent::GetOBJECTID() { return OID_RUNPLOTSCENEEVENT; }
