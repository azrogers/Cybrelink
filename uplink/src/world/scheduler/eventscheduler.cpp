...
EventScheduler::~EventScheduler() { DeleteLListData((LList<UplinkObject*>*)&events); }
...
bool EventScheduler::Load(FILE* file)
{
	...
	if (!LoadLList((LList<UplinkObject*>*)&events, file)) {
		return false;
	}
...
std::string EventScheduler::GetID() { return "SCHED"; }
