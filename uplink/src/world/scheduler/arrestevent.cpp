...
void ArrestEvent::SetName(const char* newname)
{
...
void ArrestEvent::SetReason(const char* newreason)
{
...
bool ArrestEvent::Load(FILE* file)
{
	...
	if (!LoadDynamicStringPtr(&ip, file)) {
		return false;
	}
...
std::string ArrestEvent::GetID() { return "EVT_ARR"; }

int ArrestEvent::GetOBJECTID() { return OID_ARRESTEVENT; }
