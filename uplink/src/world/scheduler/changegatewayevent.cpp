...
ChangeGatewayEvent::ChangeGatewayEvent() { newgatewaydef = NULL; }
...
char* ChangeGatewayEvent::GetShortString()
{
	...
	UplinkSnprintf(shortstring,
				   shortstringsize,
				   "Exchanging gateway for '%s'",
				   (newgatewaydef) ? newgatewaydef->name : "NULL");
	return shortstring;
}

char* ChangeGatewayEvent::GetLongString() { return GetShortString(); }
...
std::string ChangeGatewayEvent::GetID() { return "EVT_CGE"; }

int ChangeGatewayEvent::GetOBJECTID() { return OID_CHANGEGATEWAYEVENT; }
