...
void DisconnectedScreen::SetNextPage(int newnextpage) { nextpage = newnextpage; }

void DisconnectedScreen::SetTextMessage(const char* newtextmessage)
{
...
std::string DisconnectedScreen::GetID() { return "SCR_DISC"; }

int DisconnectedScreen::GetOBJECTID() { return OID_DISCONNECTEDSCREEN; }
