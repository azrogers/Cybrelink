...
#define COMPUTER_TYPE_ANY                                                                                    \
	COMPUTER_TYPE_PUBLICACCESSSERVER | COMPUTER_TYPE_INTERNALSERVICESMACHINE                                 \
		| COMPUTER_TYPE_CENTRALMAINFRAME | COMPUTER_TYPE_PUBLICBANKSERVER | COMPUTER_TYPE_PERSONALCOMPUTER   \
		| COMPUTER_TYPE_VOICEPHONESYSTEM | COMPUTER_TYPE_LAN
...
public:
	...
	void SetCompanyName(const char* newname);
	...
	static void GenerateAccessCode(const char* code, char* result, size_t resultsize);
	static void GenerateAccessCode(const char* name, const char* code, char* result, size_t resultsize);
	static void GenerateAccessCode(int accNo, const char* code, char* result, size_t resultsize);
