...
public:
	...
	bool IsPlayerAccount(const char* bankip,
						 const char* accno); // True if this account is owned by the player
	...
	static int TimeToTrace(char* tracerIP,
						   char* routerIP); // How long for the people at tracerIP to trace through routerIP
