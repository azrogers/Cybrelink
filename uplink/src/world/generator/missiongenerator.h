...
public:
	...
	*/
	...
	static Mission*
	Generate_PayFine(Person* person, Company* company, int amount, Date* duedate, char* reason);
	...
	static Mission* Generate_TraceUser_MoneyTransfer(Company* employer,
													 BankComputer* source,
													 BankComputer* target,
													 BankAccount* sacc,
													 BankAccount* tacc,
	...
	*/
	...
	static void MissionNotCompleted(Mission* mission, Person* person, Message* message, const char* reason);
	...
	*/
	...
	static void MissionFailed(Mission* mission, Person* person, const char* reason);
};
