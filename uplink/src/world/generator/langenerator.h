...
public:
	...
	static Computer* LoadLAN(const char* filename);
	static Computer* GenerateLAN(const char* companyname, int difficulty); // 0 = low, 5 = high
	...
	static void GenerateLAN_Level0Cluster(LanComputer* comp,
										  LanCluster* cluster,
										  ...
										  int width,
										  int height);
	static void GenerateLAN_Level1Cluster(LanComputer* comp,
										  LanCluster* cluster,
										  LList<int>* usedRadioFrenquencies,
										  int x,
										  int y,
										  ...
										  int height);
	static void
	GenerateLAN_Level2Cluster(LanComputer* comp, LanCluster* cluster, LList<int>* usedRadioFrenquencies);
	static void
	GenerateLAN_Level3Cluster(LanComputer* comp, LanCluster* cluster, LList<int>* usedRadioFrenquencies);
	static void
	GenerateLAN_Level4Cluster(LanComputer* comp, LanCluster* cluster, LList<int>* usedRadioFrenquencies);

	static void
	GenerateLAN_BoundingBox(LanComputer* comp, LanCluster* cluster, int x, int y, int width, int height);
	...
	static int GenerateModem(LanComputer* comp,
							 LanCluster* cluster,
							 int x,
							 int y,
							 int security,
							 char* phoneNum = NULL,
							 size_t phoneNumsize = 0);
...
public:
	...
	int
	AddLanSystem(int TYPE, int x, int y, int security = 2, int screenIndex = -1, int dataScreenIndex = -1);
	int AddLanLink(int from, float fromX, float fromY, int to, float toX, float toY, int security);
	bool VerifyLanLink(int from, float fromX, float fromY, int to, float toX, float toY, int security);
