...
bool MainMenu::IsVisible() { return (InScreen() != MAINMENU_UNKNOWN); }
...
void MainMenu::RunScreen(int SCREENCODE)
{
	...
	case MAINMENU_LOGIN:
		screen = new LoginInterface();
		break;
	case MAINMENU_LOADING:
		screen = new LoadingInterface();
		break;
	case MAINMENU_FIRSTLOAD:
		screen = new FirstTimeLoadingInterface();
		break;
	case MAINMENU_OPTIONS:
		screen = new OptionsInterface();
		break;
	case MAINMENU_OBITUARY:
		screen = new ObituaryInterface();
		break;
	case MAINMENU_CONNECTIONLOST:
		screen = new ConnectionLostInterface();
		break;
	case MAINMENU_DISAVOWED:
		screen = new DisavowedInterface();
		break;
	case MAINMENU_THETEAM:
		screen = new TheTeamInterface();
		break;
	case MAINMENU_CLOSING:
		screen = new ClosingInterface();
		break;
	case MAINMENU_DEMOGAMEOVER:
		screen = new DemoGameOverInterface();
		break;
	case MAINMENU_REVELATIONWON:
		screen = new RevelationWonInterface();
		break;
	case MAINMENU_REVELATIONLOST:
		screen = new RevelationLostInterface();
		break;
	case MAINMENU_WAREZGAMEOVER:
		screen = new WarezGameOverInterface();
		break;

	case MAINMENU_GENERICOPTIONS:
		screen = new GenericOptionsInterface();
		break;
	case MAINMENU_NETWORKOPTIONS:
		screen = new NetworkOptionsInterface();
		break;
	case MAINMENU_THEME:
		screen = new ThemeInterface();
		break;
	case MAINMENU_GRAPHICOPTIONS:
		screen = new GraphicOptionsInterface();
		break;
...
bool MainMenu::Load(FILE* file) { return true; }
...
std::string MainMenu::GetID() { return "MMI"; }
