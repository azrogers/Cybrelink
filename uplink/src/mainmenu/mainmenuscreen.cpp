...
MainMenuScreen::MainMenuScreen() { this->interface_buttons = new DArray<char*>; }
...
bool MainMenuScreen::ReturnKeyPressed() { return false; }

void MainMenuScreen::Update() { }

bool MainMenuScreen::IsVisible() { return false; }

int MainMenuScreen::ScreenID() { return 0; }

void MainMenuScreen::RegisterButton(
	int x, int y, int width, int height, const char* caption, const char* tooltip, const char* newname)
{
...
void MainMenuScreen::RegisterButton(
	int x, int y, int width, int height, const char* caption, const char* newname)
{
