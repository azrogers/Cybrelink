...
void ClosingInterface::Update()
{
	...
	if (EclGetAccurateTime() > timesync) {
		...
		const char* captions[] = { "Judgement", "Perception", "Thinking",	 "Feeling",
								   "Sensation", "Intuition",  "Extraversion" };
...
bool ClosingInterface::IsVisible() { return (EclGetButton("closing_text") != NULL); }

int ClosingInterface::ScreenID() { return MAINMENU_CLOSING; }
