...
void OptionsInterface::ThemeOptionsClick(Button* button) { app->GetMainMenu()->RunScreen(MAINMENU_THEME); }
...
void OptionsInterface::Create()
{
	...
	if (!IsVisible()) {
		...
		button_assignbitmaps("gameoptions",
							 "mainmenu/gameoptions.tif",
							 "mainmenu/gameoptions_h.tif",
							 "mainmenu/gameoptions_c.tif");
		button_assignbitmaps("graphicsoptions",
							 "mainmenu/graphicsoptions.tif",
							 "mainmenu/graphicsoptions_h.tif",
							 "mainmenu/graphicsoptions_c.tif");
		button_assignbitmaps("soundoptions",
							 "mainmenu/soundoptions.tif",
							 "mainmenu/soundoptions_h.tif",
							 "mainmenu/soundoptions_c.tif");
#ifdef MULTIMONITOR_SUPPORT
		button_assignbitmaps("networkoptions",
							 "mainmenu/networkoptions.tif",
							 "mainmenu/networkoptions_h.tif",
							 "mainmenu/networkoptions_c.tif");
#endif
		button_assignbitmaps(
			"themeoptions", "mainmenu/theme.tif", "mainmenu/theme_h.tif", "mainmenu/theme_c.tif");
		button_assignbitmaps(
			"mainmenu", "mainmenu/exitgame.tif", "mainmenu/exitgame_h.tif", "mainmenu/exitgame_c.tif");
...
bool OptionsInterface::IsVisible() { return (EclGetButton("gameoptions") != NULL); }

int OptionsInterface::ScreenID() { return MAINMENU_OPTIONS; }
