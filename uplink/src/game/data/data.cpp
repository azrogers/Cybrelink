...
const UplinkRating UPLINKRATING[] = { "Unregistered", 0,	"Registered",	1,	 "Beginner",	  2,
									  "Novice",		  6,	"Confident",	15,	 "Intermediate",  35,
									  "Skilled",	  60,	"Experienced",	90,	 "Knowledgeable", 125,
									  "Uber-Skilled", 160,	"Professional", 220, "Elite",		  300,
									  "Mage",		  400,	"Expert",		600, "Veteren",		  1000,
									  "Techno-mage",  1500, "TERMINAL",		2500 };

const UplinkRating NEUROMANCERRATING[] = {
	"Morally bankrupt", -1024, "Sociopathic", -512, "Indiscriminate", -128, "Notorious",	 -32,
	"Untrustworthy",	-16,   "Neutral",	  0,	"Aggressive",	  32,	"Single minded", 64,
	"Activist",			256,   "Anarchic",	  1024, "Revolutionary",  2048,
};

const int NEUROMANCERCHANGE[] = {
	0, // Special
	0, // Steal file
	5, // Destroy file
	0, // Find data
...
const PhysicalGatewayLocation PHYSICALGATEWAYLOCATIONS[] = {
...
const PhysicalGatewayLocation PHYSICALGATEWAYLOCATIONS_DEFCON[] = {
...
const ComputerUpgrade SOFTWARE_UPGRADES[] = {
	...
	/*
								"Encryption_Bypass",		5,		6000,	1,		1,  	"ENCRYPTION BYPASS
	   V1.0\n" "TYPE: software.Bypasser\n\n" "Actively bypasses encryption systems with a security level of
	   1\n" "All bypassers require a 'HUD:ConnectionAnalysis' upgrade first",

								"Encryption_Bypass",		5,		8000,	1,		2,  	"ENCRYPTION BYPASS
	   V2.0\n" "TYPE: software.Bypasser\n\n" "Actively bypasses encryption systems with a security level of 2
	   or below\n" "All bypassers require a 'HUD:ConnectionAnalysis' upgrade first",

								"Encryption_Bypass",		5,		10000,	1,		3,  	"ENCRYPTION BYPASS
	   V3.0\n" "TYPE: software.Bypasser\n\n" "Actively bypasses encryption systems with a security level of 3
	   or below\n" "All bypassers require a 'HUD:ConnectionAnalysis' upgrade first",

								"Encryption_Bypass",		5,		12000,	1,		4,  	"ENCRYPTION BYPASS
	   V4.0\n" "TYPE: software.Bypasser\n\n" "Actively bypasses encryption systems with a security level of 4
	   or below\n" "All bypassers require a 'HUD:ConnectionAnalysis' upgrade first",

								"Encryption_Bypass",		5,		14000,	1,		5,  	"ENCRYPTION BYPASS
	   V5.0\n" "TYPE: software.Bypasser\n\n" "Actively bypasses encryption with a security level of 5 or
	   below\n" "All bypassers require a 'HUD:ConnectionAnalysis' upgrade first",
	*/
	"File_Copier",
	1,
	...
	"IP PROBE V2.0\n"
	"TYPE: software.Other\n\n"
	"Scans a given IP address for security systems and reports the types in use and their version "
	"information",
	...
	"IP PROBE V3.0\n"
	"TYPE: software.Other\n\n"
	"Scans a given IP address for security systems and reports the types in use, their version information "
	"and their status",
...
const ComputerUpgrade HARDWARE_UPGRADES[] = {
