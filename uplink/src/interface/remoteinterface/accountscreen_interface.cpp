...
AccountScreenInterface::AccountScreenInterface() { account = NULL; }
...
void AccountScreenInterface::Create()
{
	...
	if (cs) {
		...
		printf("AccountScreenInterface::Create, tried to create when GenericScreen==NULL\n");
	}
}
...
void AccountScreenInterface::Create(ComputerScreen* newcs)
{
	...
	if (!IsVisible()) {
		...
		EclRegisterButton(70,
						  ...
						  "accountscreen_accountname_title");
		...
		EclRegisterButton(70,
						  ...
						  "accountscreen_accountnumber_title");
		...
		EclRegisterButton(
			70, 200, 100, 15, "Balance", "Shows your bank balance", "accountscreen_balance_title");
		...
		EclRegisterButton(
			70, 225, 100, 15, "Loan", "Shows your the size of your loan", "accountscreen_loan_title");
		...
		EclRegisterButton(
			150, 300, 100, 15, "OK", "Return to the account management screen", "accountscreen_close");
...
bool AccountScreenInterface::IsVisible() { return (EclGetButton("accountscreen_maintitle") != 0); }

int AccountScreenInterface::ScreenID() { return SCREEN_ACCOUNTSCREEN; }
