...
char PhoneDialler::buttonnames[][9] = {
...
void PhoneDialler::DialNumber(int x, int y, const char* number, int scenario, const char* info)
{
...
bool PhoneDialler::IsVisible() { return (EclGetButton("dialler_number") != 0); }
