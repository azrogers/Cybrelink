...
void EmailInterface::Create()
{
	...
	if (!IsVisible()) {
		...
		// EclRegisterButton ( screenw - panelwidth - 3, paneltop, panelwidth, 15, "EMAIL", "Remove the email
		// screen", "email_title" );
		...
		EclRegisterButton(
			screenw - panelwidth, (paneltop + 3) + 75, (panelwidth - 7), 30, "", "email_subject");
		...
		// create_stextbox ( screenw - panelwidth - 3, paneltop + 110, panelwidth, boxheight, body.str (),
		// "email_body" );
...
bool EmailInterface::IsVisible() { return (EclGetButton("email_title") != 0); }

int EmailInterface::ScreenID() { return SCREEN_EMAIL; }
