...
InterfaceScreen::InterfaceScreen() { this->interface_buttons = new DArray<char*>; }
...
bool InterfaceScreen::IsVisible() { return false; }

int InterfaceScreen::ScreenID() { return 0; }

void InterfaceScreen::RegisterButton(
	int x, int y, int width, int height, char* caption, char* tooltip, char* newname)
{
...
void InterfaceScreen::RegisterButton(int x, int y, int width, int height, char* caption, char* newname)
{
