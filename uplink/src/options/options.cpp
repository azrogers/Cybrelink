...
void Options::CreateDefaultOptions ()
{
	...
	if (!GetOption("graphics_borderless")) SetOptionValue("graphics_borderless", 0, "Sets the game to run in borderless fullscreen (overrides fullscreen option)", true, true);
